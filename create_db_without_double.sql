...
CREATE TABLE GP_PROJECT(
	...
	,CONSTRAINT GP_PROJECT_GP_PROJECT_MANAGER0_FK FOREIGN KEY (EMP_ID) REFERENCES GP_PROJECT_MANAGER(EMP_ID) ON DELETE CASCADE
)ENGINE=InnoDB;
...
CREATE TABLE GP_PHASE(
	...
	,CONSTRAINT GP_PHASE_GP_PROJECT_FK FOREIGN KEY (PROJECT_ID) REFERENCES GP_PROJECT(PROJECT_ID) ON DELETE CASCADE
)ENGINE=InnoDB;
...
CREATE TABLE GP_EMP_REA_PHASE(
	...
	,CONSTRAINT GP_EMP_REA_PHASE_GP_PHASE_FK FOREIGN KEY (PHASE_ID) REFERENCES GP_PHASE(PHASE_ID)ON DELETE CASCADE
	,CONSTRAINT GP_EMP_REA_PHASE_GP_EMPLOYEE0_FK FOREIGN KEY (EMP_ID) REFERENCES GP_EMPLOYEE(EMP_ID) ON DELETE CASCADE
)ENGINE=InnoDB;
